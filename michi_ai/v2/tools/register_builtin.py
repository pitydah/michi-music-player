...
def register_builtin_tools(
    ...
    gw_map: dict[str, tuple[str, str]] = {
        ...
        # metadata
        "inspect_metadata": ("metadata", "inspect_metadata"),
        "inspect_selection": ("metadata", "inspect_selection"),
        "build_proposal": ("metadata", "build_proposal"),
        "preview_changes": ("metadata", "preview_changes"),
        "apply_review": ("metadata", "apply_review"),
        "rollback_metadata": ("metadata", "rollback"),
        "check_consistency": ("metadata", "check_consistency"),
        "scan_duplicates": ("metadata", "scan_duplicates"),
