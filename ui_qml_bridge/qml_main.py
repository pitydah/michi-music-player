...
def main():
    ...
    playlists_bridge = PlaylistsBridge(db=db, selection_context=selection_context_bridge, player_service=player_service)
    ...
    engine.rootContext().setContextProperty("lyricsBridge", lyrics_bridge)
