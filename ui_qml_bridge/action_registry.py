...
class ActionRegistry(QObject):
    ...
    def _init_defaults(self):
        defaults = [
            ...
            ("playback_stop", "Detener", "playback", "stop"),
            ("playback_shuffle", "Aleatorio", "playback", "shuffle"),
            ("playback_repeat", "Repetir", "playback", "repeat"),
            ("queue_clear", "Limpiar cola", "playback", "clear"),
            ...
            ("genre_play", "Reproducir género", "genre", "play"),
            ("genre_shuffle", "Mezclar género", "genre", "shuffle"),
            ("genre_queue", "Añadir género a cola", "genre", "queue"),
            ("playlist_play", "Reproducir playlist", "playlist", "play"),
            ("playlist_shuffle", "Mezclar playlist", "playlist", "shuffle"),
            ("playlist_queue", "Añadir playlist a cola", "playlist", "queue"),
            ("playlist_rename", "Renombrar playlist", "playlist", "edit"),
            ("playlist_delete", "Eliminar playlist", "playlist", "delete", True, True),
