...
CONTEXT_BINDINGS: list[ContextBinding] = [
    ...
    ContextBinding(AppBridge,           "appBridge",       required_services=("playback_service",), optional_services=("device_sync_service", "home_audio_service", "radio_service")),
    ...
    ContextBinding(NowPlayingBridge,    "nowplayingBridge", required_services=("playback_service", "queue_service")),
    ...
    ContextBinding(AudioLabBridge,      "audioLabBridge",  required_services=("audio_lab_service",), optional_services=("job_service", "process_controller")),
    ContextBinding(MetadataBridge,      "metadataBridge",  required_services=("metadata_service",), optional_services=("job_service",)),
    ContextBinding(SmartTaggingBridge,  "smartTaggingBridge", required_services=("smart_tagging_service", "worker_manager"), optional_services=("library_query_service",)),
    ContextBinding(LibraryDoctorBridge, "libraryDoctorBridge", required_services=("database", "worker_manager")),
    ContextBinding(MichiAIBridge,       "michiAiBridge",   required_services=("michi_ai_service", "job_service"), optional_services=("device_sync_service",)),
    ContextBinding(DiagnosticsBridge,   "diagnosticsBridge", required_services=("diagnostics_service", "playback_service", "worker_manager", "query_executor"), optional_services=("radio_service", "device_sync_service")),
    ContextBinding(DiscLabBridge,       "discLabBridge",   required_services=("worker_manager",), optional_services=("cd_ripper_service", "process_controller")),
