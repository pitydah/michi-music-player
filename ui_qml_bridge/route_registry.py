...
ROUTES: dict[str, dict] = {
    ...
    # Audio Lab hubs (legacy internal, not sidebar-visible)
    "audio_lab.diagnostics": {
        ...
        "source": "../pages/audio_lab/hubs/DiagnosticsHubPage.qml",
        "icon": "analysis", "order": 0, "sidebar_visible": False,
        "sidebar_group": None, "expandable": False,
        "status": "functional", "capability": None,
        "aliases": [],
    ...
    "audio_lab.identifier": {
        "route": "audio_lab.identifier", "parent": "audio_lab.analysis",
        "title": "Identificador", "breadcrumb_title": "Identificador",
        "source": "../pages/audio_lab/hubs/IdentifierHubPage.qml",
        "icon": "analysis", "order": 0, "sidebar_visible": False,
        "sidebar_group": None, "expandable": False,
        "status": "functional", "capability": None,
        "aliases": [],
    ...
    "audio_lab.backup": {
        ...
        "source": "../pages/audio_lab/hubs/BackupHubPage.qml",
        "icon": "audio_lab", "order": 0, "sidebar_visible": False,
        "sidebar_group": None, "expandable": False,
        "status": "functional", "capability": None,
        "aliases": [],
    ...
    "audio_lab.output_profiles": {
        ...
        "source": "../pages/audio_lab/hubs/OutputProfilesHubPage.qml",
        "icon": "processing", "order": 0, "sidebar_visible": False,
        "sidebar_group": None, "expandable": False,
        "status": "functional", "capability": None,
        "aliases": [],
    ...
    "audio_lab.local_intelligence": {
        "route": "audio_lab.local_intelligence", "parent": "audio_lab.analysis",
        "title": "Inteligencia Local", "breadcrumb_title": "Inteligencia Local",
        "source": "../pages/audio_lab/hubs/LocalIntelligenceHubPage.qml",
        "icon": "analysis", "order": 0, "sidebar_visible": False,
        "sidebar_group": None, "expandable": False,
        "status": "functional", "capability": None,
        "aliases": [],
