...
ROUTES: dict[str, dict] = {
    ...
    "library.albums": {"title": "lbumes", "source": "../pages/library/AlbumGridPage.qml", "category": "library", "status": "functional"},
    "library.album_detail": {"title": "lbum", "source": "../pages/library/AlbumDetailPage.qml", "category": "detail", "status": "functional", "params": {"album_key": {"required": True, "type": "string"}}},
    ...
    "library.genres": {"title": "Gneros", "source": "../pages/library/GenresPage.qml", "category": "library", "status": "functional"},
