...
ROUTES: dict[str, dict] = {
    ...
    "audio_lab.backup": {"title": "Respaldar audio", "source": "../pages/audio_lab/AudioBackupPage.qml", "category": "tools", "status": "experimental"},
    ...
    "diagnostics.identifier": {"title": "Identificador de música", "source": "../pages/DiagnosticsPage.qml", "category": "system", "status": "functional"},
