...
Item {
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            Text {
                Layout.fillWidth: true
                text: "Convierte un archivo con FFmpeg. Solo se muestran opciones que el servicio aplica realmente de extremo a extremo."
            ...
            GlassMaterial {
                ...
                ColumnLayout {
                    ...
                    Text {
                        Layout.fillWidth: true
                        text: root.selectedFile !== "" ? "Origen: " + root.selectedFile : "Selecciona un archivo para continuar."
                ...
                ColumnLayout {
                    ...
                    Text {
                        ...
                        color: root.previewResult && root.previewResult.ok === false
                            ? MichiTheme.colors.error : MichiTheme.colors.textSecondary
                        font.pixelSize: MichiTheme.typography.bodySize
                        wrapMode: Text.WordWrap
                    }
                }
            ...
            RowLayout {
                ...
                MichiButton {
                    text: "Previsualizar"
                    variant: "secondary"
                    enabled: root.bridge !== null && root.selectedFile !== "" && root.operationState !== root.stateConverting
                    onClicked: root.previewConversion()
                }
                MichiButton {
                    text: root.operationState === root.stateConverting ? "Convirtiendo…" : "Convertir"
                    variant: "primary"
                    enabled: root.bridge !== null && root.selectedFile !== ""
                        && root.operationState !== root.stateConverting
                        && root.operationState !== root.stateCancelling
                ...
                MichiButton {
                    text: "Cancelar"
                    variant: "danger"
                    visible: root.operationState === root.stateConverting || root.operationState === root.stateCancelling
                ...
                MichiButton {
                    text: "Reiniciar"
                    variant: "ghost"
                    visible: root.operationState === root.stateCompleted || root.operationState === root.stateFailed
            ...
            GlassMaterial {
                ...
                ColumnLayout {
                    ...
                    spacing: MichiTheme.spacing.sm
                    Text {
                        text: root.operationState === root.stateCompleted ? "Conversión completada"
                            : root.operationState === root.stateCancelling ? "Cancelando trabajo…" : "Conversión en curso"
                        color: root.operationState === root.stateCompleted ? MichiTheme.colors.success : MichiTheme.colors.textPrimary
                        font.pixelSize: MichiTheme.typography.bodySize
                    }
                    MichiProgressBar {
                        Layout.fillWidth: true
                        ...
                        indeterminate: root.operationState === root.stateConverting && root.progress <= 0
                    }
                    Text {
                        Layout.fillWidth: true
