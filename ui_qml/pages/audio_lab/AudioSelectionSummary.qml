...
Item {
    ...
    Accessible.name: qsTr("Resumen de selección de audio")
    ...
    GlassMaterial {
        ...
        Row {
            ...
            Text {
                text: qsTr("Seleccionados: ") + (root.selection ? root.selection.count : 0) + " archivos"
                color: MichiTheme.colors.textPrimary; font.pixelSize: MichiTheme.typography.bodySize
                anchors.verticalCenter: parent.verticalCenter
            }
            StatusBadge { text: qsTr("Audible"); kind: "success"; anchors.verticalCenter: parent.verticalCenter }
