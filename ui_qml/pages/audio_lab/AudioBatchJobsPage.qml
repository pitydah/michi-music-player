...
Item {
    ...
    Flickable {
        ...
        Column {
            ...
            Text {
                text: qsTr("Trabajos de Audio Lab")
                color: MichiTheme.colors.textPrimary
                font.pixelSize: MichiTheme.typography.pageTitleSize; font.weight: MichiTheme.typography.weightSemiBold
            }

            Text {
                text: qsTr("Cola, activos, historial, progreso por archivo, velocidad, ETA, reintentos, cancelación")
            ...
            GlassMaterial {
                ...
                Row {
                    ...
                    Column { spacing: MichiTheme.spacing.xs
                        ...
                        Text { text: qsTr("Activos"); color: MichiTheme.colors.textMuted; font.pixelSize: MichiTheme.typography.metaSize }
                    }
                    Column { spacing: MichiTheme.spacing.xs
                        ...
                        Text { text: qsTr("Total"); color: MichiTheme.colors.textMuted; font.pixelSize: MichiTheme.typography.metaSize }
                    }
                }
            }
            ...
            Repeater {
                ...
                GlassMaterial {
                    ...
                    Row {
                        ...
                        Text { width: parent.width * 0.15; text: modelData.state === "completed" ? "Completado" : qsTr("Con errores"); color: modelData.state === "completed" ? MichiTheme.colors.success : MichiTheme.colors.warning; font.pixelSize: MichiTheme.typography.metaSize; anchors.verticalCenter: parent.verticalCenter }
            ...
            Repeater {
                ...
                GlassMaterial {
                    ...
                    Row {
                        ...
                        Text { text: qsTr("Cancelado"); color: MichiTheme.colors.textMuted; font.pixelSize: MichiTheme.typography.metaSize; anchors.verticalCenter: parent.verticalCenter }
                    }
                }
            }
            ...
            StatusBadge {
                ...
                text: qsTr("Bridge de trabajos no disponible")
                kind: "disconnected"
            }
        }
    }
