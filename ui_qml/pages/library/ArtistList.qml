...
Item {
    ...
    Accessible.name: qsTr("Lista de artistas")
    ...
    GridView {
        ...
        Accessible.name: qsTr("Cuadrícula de artistas")
        ...
        Item { anchors.centerIn: parent; width: 300; height: 180; visible: root.artists.length === 0
            Column { anchors.centerIn: parent; spacing: MichiTheme.spacing.lg
                Rectangle { anchors.horizontalCenter: parent.horizontalCenter; width: 48; height: 48; radius: MichiTheme.radius.lg; color: MichiTheme.colors.accentSurface
                    Text { anchors.centerIn: parent; text: qsTr("AR"); color: MichiTheme.colors.accentBlue; font.pixelSize: MichiTheme.typography.cardTitleSize; font.weight: MichiTheme.typography.weightBold; opacity: MichiTheme.opacity.hover } }
                Text { anchors.horizontalCenter: parent.horizontalCenter; text: qsTr("No hay artistas"); color: MichiTheme.colors.textPrimary; font.pixelSize: MichiTheme.typography.sectionTitleSize; font.weight: MichiTheme.typography.weightMedium }
                Text { anchors.horizontalCenter: parent.horizontalCenter; text: qsTr("Refresca la biblioteca o revisa los metadatos de artista."); color: MichiTheme.colors.textSecondary; font.pixelSize: MichiTheme.typography.bodySize; horizontalAlignment: Text.AlignHCenter; wrapMode: Text.WordWrap }
