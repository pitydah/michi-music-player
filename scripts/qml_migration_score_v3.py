#!/usr/bin/env python3
"""QML Migration Score V3 — multidimensional, honest, from manifest + evidence."""
import json
import sys
from pathlib import Path

REPO = Path(__file__).resolve().parent.parent
MANIFEST = REPO / "docs" / "qml_migration_manifest_v3.json"
...
def main():
    ...
    for mod in modules:
        ...
        area_raw[area] = area_raw.get(area, 0) + s * weight

    print("# QML Migration Score V3\n")
    total = 0.0
    total_area_weight = 0
