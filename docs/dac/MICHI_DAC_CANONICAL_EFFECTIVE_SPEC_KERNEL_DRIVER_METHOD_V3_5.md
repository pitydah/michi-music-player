...
Automated closure evidence on 2026-09-17 passes the clean exact-commit gate:
519 DAC tests and 4798 full-suite tests passed, with two existing non-DAC skips.
...
R1.2 closure is published from the exact-head remote artifact for commit
`666c163b65a76d3f2496e33a889caa945485947d`, Michi CI run `35652376543`, which
records automated `GO`, physical `NOT_RUN`, 582 DAC tests passed, and 4854
full-suite tests passed with 28 classified non-DAC skips. Artifact
`dac-v35-software-closure-666c163b65a76d3f2496e33a889caa945485947d` has GitHub
digest `sha256:54c3933558a464d75a56feb6dabf8cc8af5a21b3e7ff801a116a7bdc64e8de7d`.
The earlier fix commit `0d6907e72fcc56655f326278844897a29bb9e509` (run
`35649494289`) had already passed every executable gate with only the deliberate
...
R1.3.1 closure is published from the exact-head remote artifact for commit
`ac18f39e43bdfe3f4ecd061c2208a8e50a125d9f`, Michi CI run `35764363005`, which records automated `GO`, physical `NOT_RUN`,
667 DAC tests passed, and 4941 full-suite tests passed with 28 classified
non-DAC skips. Artifact
`dac-v35-software-closure-ac18f39e43bdfe3f4ecd061c2208a8e50a125d9f` has GitHub digest `sha256:4a2c6b36eea62dcf4231106a99f112327bf0ce41085c19b80abab7eefe0e424e`.
...
R1.3.2 code closure is published from the exact-head remote artifact for
commit `0876175744de2b1414fb4a0ded0088bde6b9cee1`, Michi CI run `35795736917`, which records automated `GO`, physical
`NOT_RUN`, 678 DAC tests passed, and 4952 full-suite tests passed with 28
classified non-DAC skips. Artifact
`dac-v35-software-closure-0876175744de2b1414fb4a0ded0088bde6b9cee1` has GitHub digest `sha256:2633239f6894d7993b62683188fea8cbc2c3b168284abeec62f674607c833c28`. This closure
commit is the PUBLICATION head; the code closure remains bound to the
...
R1.3.3 closure is published from the exact-head remote artifact for commit
`4fffbcd0c3e085e75814ba11227074ac2701c42e`, Michi CI run `35804337776`, which records automated `GO`, physical `NOT_RUN`,
691 DAC tests passed, and 4965 full-suite tests passed with 28 classified
non-DAC skips. Artifact
`dac-v35-software-closure-4fffbcd0c3e085e75814ba11227074ac2701c42e` has GitHub digest `sha256:b0fbfd367a5dbe6a8dfb7a4bd2f6b0dd7eddb02971df169068c3a72f6c39e934`. Nomenclature:
`4fffbcd0c3e085e75814ba11227074ac2701c42e` is the R1.3.3 CODE_CLOSURE_HEAD; the commit that records this evidence
is the R1.3.3 PUBLICATION_HEAD.
