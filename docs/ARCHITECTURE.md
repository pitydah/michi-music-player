...
| Tests          | 330 pytest tests passing; CI green (lint/test/build, offscreen)                            | Verified                                                                    |
