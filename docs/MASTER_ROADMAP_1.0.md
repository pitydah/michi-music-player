...
| M4 Queue                     | TESTED     | Queue basics, TD-015 pending identity, TD-016 cancellation terminal, repeat modes (none/one/all) and deterministic shuffle navigation — all TESTED (a977378, f93a6a8; 460-pass suite) | Reorder is Post-1.0 (not a blocker)                                                               |
