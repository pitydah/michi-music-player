...
**IMPLEMENTED / PHYSICAL QUALIFICATION PENDING** (DAC-V35-100R1.3 local
...
- `DAC-V35-100R1.3` playback compatibility, output-mode separation, and native
  lifecycle final seal — **CLOSED-AUTOMATED / LOCAL GO; REMOTE PUBLICATION
  PENDING**. Device identity is separated from the transport policy
