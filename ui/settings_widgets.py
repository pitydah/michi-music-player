...
from ui.central.central_tokens import (
    BG_CONTENT, SURFACE_GLASS, SURFACE_GLASS_HOVER,
    BORDER_NORMAL, TEXT_PRIMARY, TEXT_NORMAL, TEXT_SECONDARY, TEXT_DISABLED,
)

_BG = BG_CONTENT
_PANEL = SURFACE_GLASS
_HOVER = SURFACE_GLASS_HOVER
_BORDER = BORDER_NORMAL
_TEXT = TEXT_PRIMARY
_TEXT2 = TEXT_NORMAL
_TEXT3 = TEXT_SECONDARY
_TEXT_DIM = TEXT_DISABLED
