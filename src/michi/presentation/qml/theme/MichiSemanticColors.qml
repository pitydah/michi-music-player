...
QtObject {
    ...
    // Dense track table states (editorial playlist rows)
    readonly property color rowHover: Qt.rgba(1, 1, 1, 0.035)
    readonly property color rowSelected: Qt.rgba(1, 1, 1, 0.06)
    readonly property color rowDivider: Qt.rgba(1, 1, 1, 0.05)
