...
QtObject {
    ...
    readonly property bool blurEligible: role === MichiMaterialRole.control
        || role === MichiMaterialRole.elevated
    ...
    readonly property color baseColor: role === MichiMaterialRole.backplane
        ? MichiPalette.obsidian : role === MichiMaterialRole.selected
            ? MichiSemanticColors.surfaceSelected : MichiPalette.obsidianRaised
}
