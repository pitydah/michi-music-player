...
class TestM4R1FinalSealPlaylistTrack:
    ...
    def test_pl07_more_options_does_not_trigger_playback(self):
        ...
        # SEMANTIC INTEGRATION: el botón More abre el menú — nunca
        # playTrackRequested (el click de fila vive en rowSurface).
        assert "trackMenu.popup()" in qml
        assert "root.trackSelected(modelData.path)" in qml
