...
DEFAULTS = {
    ...
    "mobile_sync/bind_host": "127.0.0.1",
    "mobile_sync/allow_lan_pairing": False,
    "mobile_sync/tls_mode": "none",
    "mobile_sync/allowed_networks": [],
    "mobile_sync/legacy_code_pairing_enabled": False,
    "mobile_sync/signature_pairing_enabled": True,
