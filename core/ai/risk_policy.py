...
_ACTION_RISK_MAP: dict[str, RiskLevel] = {
    ...
    "apply_library_repair": RiskLevel.MODERATE,
    "restore_setting": RiskLevel.MODERATE,
    ...
    "playback_play": RiskLevel.LOW,
    "playback_pause": RiskLevel.LOW,
    "playback_next": RiskLevel.LOW,
    "playback_prev": RiskLevel.LOW,
    "playback_volume": RiskLevel.LOW,
    "suggestion": RiskLevel.LOW,
    "search_library": RiskLevel.SAFE,
    "search_artist": RiskLevel.SAFE,
    "search_album": RiskLevel.SAFE,
    "search_genre": RiskLevel.SAFE,
    "playback_info": RiskLevel.SAFE,
    "diagnosis": RiskLevel.SAFE,
    "library_info": RiskLevel.SAFE,
    "greeting": RiskLevel.SAFE,
    "help": RiskLevel.SAFE,
    "out_of_scope": RiskLevel.SAFE,
